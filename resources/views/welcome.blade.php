...
<body class="text-gray-800">
    ...
    <button onclick="document.getElementById('searchInput').focus()" class="absolute left-2 text-gray-400 hover:text-pink-500 transition-colors">
        ...
        <div class="flex items-center space-x-5">
            <a href="https://wa.me/994708685101" target="_blank" class="text-[#25D366] hover:scale-110 transition-transform flex items-center justify-center">
...
function checkout() {
    ...
    const whatsappUrl = `https://wa.me/994708685101?text=${encodeURIComponent(message)}`;
